...
description: Prediction engine mobile integration spec — TypeScript types, Zustand stores, screen specs (AlertDetail, BlockDetail, PredictionFeedback, SprayLog), API service pattern, push notifications, and offline-first strategy. Use when implementing prediction-related screens or services.
---
