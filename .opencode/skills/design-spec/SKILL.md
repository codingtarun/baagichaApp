---
name: design-spec
description: Complete design specification for the Baagicha React Native app — colors, typography, layout, shadows, border radius, spacing, animations, component patterns, and all screens. Use when implementing UI components or ensuring design consistency.
---
