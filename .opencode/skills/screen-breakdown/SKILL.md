---
name: screen-breakdown
description: Complete screen breakdown for the Baagicha React Native app — 17 screens across 5 tabs with navigation structure, components, and UI specifications. Use when implementing or modifying screens.
---
