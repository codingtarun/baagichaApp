---
name: api-reference
description: Complete API reference for the Baagicha mobile app — Sanctum auth, actions, weather, notifications, prediction engine, intelligence card, orchard blocks, spray logs, and route map. Use when implementing API calls or understanding endpoints.
---
